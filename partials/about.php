      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">We Unlock Doors to Your Real Estate Dreams</h1>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2  d-none d-lg-block">
              <div class="title-vertical d-flex justify-content-start">
                <span><img src="img/queens-logo.png" style="width: 250px; height: 60px; margin-top: -30px" alt="footer logo" srcset=""> Exclusive Property</span>
              </div>
            </div>
            <div class="col-md-6 col-lg-5 section-md-t3">
              <div class="title-box-d">
                <h3 class="title-d">We Are 
                  <span class="color-d">The Queens Realty</span>
                  <br> Management.</h3>
              </div>
