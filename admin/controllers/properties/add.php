...
if (isset($_POST['create'])) {
    ...
    $sql = "INSERT INTO properties (title, price, category_id, type_id, size, bedrooms, bathrooms, garages, status, amenities, location,  description)
            VALUES ('$title', $price, $category_id, $type_id, '$size', $bedrooms, $bathrooms, $garages, '$status', '$amenities', '$location', '$description')";
