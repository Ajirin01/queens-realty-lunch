<?php include_once('inc/root_dir.php'); ?>
<?php
    session_start();
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="property.php">
                                <!-- <i class="fa fa-star"></i> <span>Widgets</span> <small class="badge pull-right bg-green">new</small> -->
                                <i class="fa fa-star"></i> <span>Properties</span>
                            </a>
                            <a href="category.php">
                                <!-- <i class="fa fa-star"></i> <span>Widgets</span> <small class="badge pull-right bg-green">new</small> -->
                            ...
                            <a href="type.php">
                                <!-- <i class="fa fa-star"></i> <span>Widgets</span> <small class="badge pull-right bg-green">new</small> -->
                                <i class="fa fa-star"></i> <span>Types</span>
                            </a>
                        </li>
                    </ul>
                </section>
